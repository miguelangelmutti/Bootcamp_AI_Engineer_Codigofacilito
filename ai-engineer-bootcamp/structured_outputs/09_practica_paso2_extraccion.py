"""
Clase 4 - Práctica Paso 2: Extracción con Structured Outputs
Extraer una receta de texto desordenado usando Pydantic + API.
"""
...
print(f"Tiempo: {receta.tiempo_minutos} minutos")
